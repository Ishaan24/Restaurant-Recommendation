...
cuisine_map = {'Biriyani':'Hyderabadi', 'Tex-Mex':'Mexican', 'Finger Food':'Fast Food', 'Ice Cream':'Desserts',
                   'Pizza':'Italian', 'Burger':'Fast Food', 'Tea':'Cafe', 'Beverages':'Cafe', 'Juices':'Cafe',
                   'Kerala':'South Indian', 'Raw Meats': 'American', 'Sushi':'Japanese', 'Greek':'European',
                   'British':'European','Korean':'Asian', 'Middle Eastern':'Arabian', 'Andhra':'Hyderabadi',
                   'Spanish':'European', 'German':'European'}

for i in range(len(user_cuisines)):
    if user_cuisines[i] in cuisine_map:
        user_cuisines[i] = cuisine_map(user_cuisines[i])
